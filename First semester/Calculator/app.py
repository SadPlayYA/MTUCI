...
class Calculator(QWidget):
    def __init__(self):
        ...
        self.b_back = QPushButton("СТЕРЕТЬ", self)
        self.hbox_first.addWidget(self.b_back)   
        ...
        self.b_back.clicked.connect(lambda: self.input.setText(''))
        ...
        if self.input.text() != '.':
            ...
            if self.op == "/":
                if self.num_2 != 0:
                    ...
                    self.input.setText('Человек, на ноль делить нельзя!')
